...
app.get('/product/p', (req, res) => {
    db.any('SELECT id_product, product_name FROM product ORDER BY id_product;')
        .then(result => {
            res.json(result);
        })
        .catch(error => {
...
app.get('/store_product/s', (req, res) => {
    db.any('SELECT upc FROM store_product;')
        .then(result => {
            res.json(result);
        })
        .catch(error => {
...
app.get('/store_product/lol/:id_product', (req, res) => {
    ...
    db.oneOrNone('SELECT id_product, promotional_product FROM store_product WHERE id_product = $1 AND promotional_product = true;', [id_product])
        .then(result => {
            res.json(result);
        })
        .catch(error => {
...
app.get('/store_product/l/:upc', (req, res) => {
    ...
    db.oneOrNone('SELECT id_product FROM store_product WHERE upc = $1 ;', [upc])
        .then(result => {
            res.json(result);
        })
        .catch(error => {
